...
### Pre-Seed Deck
- Emphasize: Team, problem, early validation
- Market size: TAM focus, less detail on SAM/SOM
- Financials: 12-18 month projections only
- Ask: Typically $500K-$2M

### Seed Deck
- Emphasize: Traction, product-market fit indicators
- Market size: Full TAM/SAM/SOM breakdown
- Financials: 2-3 year projections
- Ask: Typically $2M-$5M

### Series A Deck
- Emphasize: Growth metrics, scalable economics
- Market size: Quantified SOM with go-to-market proof
- Financials: 3-5 year projections with unit economics
- Ask: Typically $5M-$15M

### Series B+ Deck
- Emphasize: Scale, category leadership, expansion
- Market size: Positioning in total market
- Financials: 5+ year projections, path to profitability
- Ask: Typically $15M-$50M+

## Demo Day Structure

For accelerator or conference presentations (5-7 slides, 3-5 minutes):

1. **Hook** - Grab attention in first 10 seconds
2. **Problem** - Pain point with relatable story
3. **Solution** - Product reveal with demo visual
4. **Traction** - Key metrics that validate
5. **Team** - Why you'll win
6. **The Ask** - Funding, partnerships, or users
7. **Contact** - Website, email, social
...
- Standard pitch deck structures used by top-tier VC firms (Sequoia, a16z, Y Combinator)
- Board meeting best practices from experienced startup boards
- Product launch frameworks used by successful startups