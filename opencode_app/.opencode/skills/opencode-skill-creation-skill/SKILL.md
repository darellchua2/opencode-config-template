...
**Example**:
```bash
mkdir -p skills/python-pytest-creator-skill
touch skills/python-pytest-creator-skill/SKILL.md
```
...
### Created Skill: python-pytest-creator-skill

**Location**: `skills/python-pytest-creator-skill/SKILL.md`
