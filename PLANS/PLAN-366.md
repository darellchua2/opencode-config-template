...
- [ ] **2.4** Normalize §6a canonical filename: change the intro's `PLANS/PLAN-GIT-<issue-number>.md` to `PLANS/PLAN-${KEY}.md` as the single canonical name; adopted drafts named `PLAN-GIT-*.md` are `git mv`'d to the canonical form
