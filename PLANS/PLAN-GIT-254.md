...
- [x] **1.1** Add "Mandatory Consumer Coverage Gate" section to `opencode_app/.opencode/agents/go-reviewer-subagent.md` (~line 108)
...
- [x] **1.2** Add "Mandatory Consumer Coverage Gate" section to `opencode_app/.opencode/agents/java-reviewer-subagent.md` (~line 138)
...
- [x] **1.3** Add "Mandatory Consumer Coverage Gate" section to `opencode_app/.opencode/agents/python-reviewer-subagent.md` (~line 110)
...
- [x] **1.4** Add "Mandatory Consumer Coverage Gate" section to `opencode_app/.opencode/agents/rust-reviewer-subagent.md` (~line 109)
...
- [x] **1.5** Add "Mandatory Consumer Coverage Gate" section to `opencode_app/.opencode/agents/typescript-reviewer-subagent.md` (~line 117)
...
- [x] **1.6** Add "Mandatory Consumer Coverage Gate" section to `opencode_app/.opencode/agents/uiux-reviewer-subagent.md` (~line 111)
...
- [x] **2.1** Add mandatory consumer-enumeration step to `opencode_app/.opencode/agents/autoresearch-code-subagent.md` (~line 129, CodeGraph Integration section)
...
- [x] **2.2** Add "Consumer Coverage" sub-step to `opencode_app/.opencode/skills/autoresearch-code-skill/SKILL.md`
...
- [x] **3.1** Spot-check 2 patched reviewer agents by reading back the gate sections
...
- [x] **3.2** Spot-check autoresearch agent and skill by reading back the consumer-enumeration step
...
- [x] **3.3** Cross-reference: confirm `autoresearch-ml-*` and `autoresearch-research-*` were NOT modified
...
- [x] **4.1** Decide: normalize 28 skills' array values in `metadata:` to comma-separated strings, OR verify runtime tolerance and document it
...
- [x] **4.2** Apply chosen convention across the 28 affected skills
...
- [x] **4.3** Document the decision in `docs/audits/skill-yaml-compliance-audit.md` — append a "Resolution" section
...
- [x] All 6 reviewer agents have a Mandatory Consumer Coverage Gate with grep/glob fallback instructions and a `Status: partial` rule.
- [x] `autoresearch-code-subagent` and `autoresearch-code-skill` enforce consumer enumeration before keep/revert.
- [x] Metadata array-value convention is decided and applied (or explicitly waived with reasoning documented).
- [x] No changes to `autoresearch-ml-*` or `autoresearch-research-*`.
