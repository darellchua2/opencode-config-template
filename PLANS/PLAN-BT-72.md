...
**Branch**: `BT-72`
**Created**: 2026-06-26
**Status**: Created 2026-06-26 · Revised per architecture-review + opencode-tooling review (16 findings applied)
...
- [ ] `requirements-specialist-subagent.md` exists (renamed from prd-specialist, glm-5-turbo, internal, permits srs+rendering+domain-modeling+grilling+docx+xlsx+**search-first** skills, task image-analyzer+xlsx allow)
