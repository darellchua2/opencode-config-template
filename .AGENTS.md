...
| "create architecture diagram" | `ascii-diagram-creator` skill | Matches `diagram*` pattern |
...
| Diagram creation | `ascii-diagram-creator` skill | Create ASCII diagrams as images |
...
#### Diagram Creation
- `diagram*`, `architecture*`, `flowchart*`, `uml*`, `sequence*` → `ascii-diagram-creator` skill
