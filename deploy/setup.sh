...
SKILL_PROFILE="lean"     # --skill-profile lean|full (default lean: primary sees 44 skills; full = shipped 103 verbatim)
...
#   full           -> verified no-op (shipped 103-allow allowlist stays verbatim)
