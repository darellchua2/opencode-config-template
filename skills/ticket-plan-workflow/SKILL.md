...
---
*Created with ticket-plan-workflow*
```
...
|----------|---------|---------|
| GitHub Issues | `GIT-{ISSUE_NUMBER}` | `GIT-123` |
| JIRA | `{TICKET_KEY}` | `PROJ-456` |
...
# Determine branch name based on platform
if [ "$PLATFORM" = "github" ]; then
  BRANCH_NAME="GIT-$ISSUE_NUMBER"
else
...
| Platform | Pattern | Example |
|----------|---------|---------|
| GitHub Issues | `PLAN-GIT-{ISSUE_NUMBER}.md` | `PLANS/PLAN-GIT-123.md` |
| JIRA | `PLAN-{TICKET_KEY}.md` | `PLANS/PLAN-PROJ-456.md` |
...
## Ticket Reference
- **Platform**: $PLATFORM (GitHub/JIRA)
- **ID**: $TICKET_ID
- **URL**: $TICKET_URL
- **Labels/Type**: $LABELS_OR_TYPE
