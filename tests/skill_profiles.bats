...
#      exactly 44 allows + "*": "deny"; full leaves the shipped block verbatim.
...
@test "skill-profiles: lean has exactly 44 keys" {
...
@test "apply-skill-profile: lean rewrites scratch deployed config to 44 allows + * deny" {
